 ...
 *
 */
public class FullSaveDocument {
    final static String INPUT_PDF = "pdfjavatoolkit-ds.pdf";
    final static String OUTPUT_PDF = "FullSave.pdf";
    ...
    public static void main(final String[] args) throws MalformedURLException {
        ...
        if (args.length == 2) {
            ...
            inputUrl = FullSaveDocument.class.getResource(INPUT_PDF);
            outputUrl = IoUtils.createUrlFromPath(OUTPUT_PDF);
        }

        fullSaveDocument(inputUrl, outputUrl);
    }
     ...
     * @param outputUrl
     */
    private static void fullSaveDocument(final URL inputUrl, final URL outputUrl) {
        ...
        try {
            ...
            final PDFSaveFullOptions options = PDFSaveFullOptions.newInstance();
