 ...
 *
 */
public class ConvertPdfToPdfA2 {
    private static final Logger LOGGER = Logger.getLogger(ConvertPdfToPdfA2.class.getName());
    ...
    public static void main(final String... args) throws Exception {
        ...
        if (args.length == 3) {
            ...
            if (conformanceLevelInput.equals("a")) {
                conformanceLevel = PDFA2ConformanceLevel.Level_2a;
            } else if (conformanceLevelInput.equals("b")) {
            ...
            } else if (conformanceLevelInput.equals("u")) {
                conformanceLevel = PDFA2ConformanceLevel.Level_2u;
            } else {
                throw new IllegalArgumentException("Did not specify a valid PDF/A2 conformance level, options are 'a', 'b', or 'u'");
            }
        } else {
